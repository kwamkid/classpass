        ...
        <div className="max-w-md w-full space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/login"
                className="block w-full bg-primary-500 text-white py-3 px-4 rounded-lg font-medium hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">ไม่ต้องกังวล เราจะส่งลิงก์สำหรับรีเซ็ตรหัสผ่านให้คุณ</p>
        </div>
